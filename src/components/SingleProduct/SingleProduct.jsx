...
const SingleProduct = (props) => {
  ...
  useEffect(() => {
    ...
    if (loggedIn && user) {
      user.wishlist.includes(currentId)
        ? setItemPresent(true)
  ...
  return (
    <div className="singleProductContainer">
      <div className="singleProductImage">
        <img
          src={
            process.env.REACT_APP_IMAGE_URL + "/" + props.imageUrl.substring(8)
          }
          alt={props.name}
        />
      </div>
      ...
      <div className="singleProductDetails">
        ...
        <div className="availability">
          ...
          {itemPresent ? (
            ...
            <FavoriteBorderIcon className="bi-heart" onClick={handleWishlist} />
          )}
        </div>
